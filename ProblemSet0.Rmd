...
Note: This is not a real problem set. Your first problem set is labelled ProblemSet1 and will be available later on in Module 1, and will be due on Thursday September 16 at 11:59am ET, a few days after our first set of classes. The purpose of Problem Set 0 (this problem set) is to:
